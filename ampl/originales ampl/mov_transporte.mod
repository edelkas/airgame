...
set L;			#Conjunto de casillas en las que movilizar el avión de transporte
...
#2) La distancia de la casilla debe ser igual o inferior al alcance máximo del avión de transporte
R2 D[j] <=41
