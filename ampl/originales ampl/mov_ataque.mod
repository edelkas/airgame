...
set L;			#Conjunto de casillas en las que movilizar el avión de ataque
...
#2) La distancia de la casilla debe ser igual o inferior al alcance máximo del avión de ataque
R2 D[j] <=26
