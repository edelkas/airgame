...
set L;			#Conjunto de casillas en las que movilizar el helicóptero
...
#Restricciones:
#1) No se puede colocar el mismo helicóptero en más de una casilla
R1 sum X[j] =1

#2) La distancia de la casilla debe ser igual o inferior al alcance máximo del helicóptero
R2 D[j] <=2
